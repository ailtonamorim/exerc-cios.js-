...
function notasProvas(nota1, nota2, nota3){
...
console.log(`a média desse aluno é ${notasProvas(8,5,9)}`)
...
function  provaFinal(nota1,nota2,nota3,notaFinal){
    let media  = notasProvas(nota1, nota2, nota3);
...
console.log(`a média final do aluno é ${provaFinal(8,5,9,8)}`);
...
function grausCelsius(temperaturaCelsius){
    let farenheit = (9 / 5) * temperaturaCelsius + 32;
    return farenheit; 


}
console.log(`a temperatura correspondente em Fahrenheit é de ${grausCelsius(35)}ºF`)
...
function valorProduto(valorDoProduto){
    let valorPago = valorDoProduto * 1.08875;
    return valorPago;
}


console.log(`O valor a ser pago é ${valorProduto(150)}`);
